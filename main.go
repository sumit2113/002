...
import (
	...
	_ "github.com/sumit2113/002/docs"
...
func main() {
	...
	alarms = append(alarms, Alarm{ID: rand.Intn(9999), Message: "Modem failure at BTS", Title: "Modem", StartTime: time.Now(), Severity: "Major"})
	alarms = append(alarms, Alarm{ID: rand.Intn(9999), Title: "CPU", Message: "CPU threshold exceeded by 90%'", StartTime: time.Now(), Severity: "Minor"})
	alarms = append(alarms, Alarm{ID: rand.Intn(9999), Title: "Service", Message: "Critcal service is down", StartTime: time.Now(), Severity: "Major"})
...
func handleRequests() {
	...
	router.HandleFunc("/alarms/generateAlarms", createAlarm).Methods("POST")
	router.HandleFunc("/alarms/alarms", getAllAlarms).Methods("GET")
	router.HandleFunc("/alarms/clearAlarms/{id}", deleteAlarm).Methods("DELETE")
	router.HandleFunc("/alarms/updateAlarms/{id}", updateAlarm).Methods("PUT")
